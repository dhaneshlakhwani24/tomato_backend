...
const verifyOrder = async (req, res) => {
    ...
    try {
        ...
        console.log(error);
        res.json({ success: false, message: "An error occurred while verifying the order." });
    }
};
...
const userOrders = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({ success: false, message: "An error occurred while fetching user orders." });
    }
};
...
const listOrders = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({ success: false, message: "An error occurred while listing orders." });
    }
};
